...
打开 `index.html` 分别预览简体中文与 English 两套成品。每套包含 5 张 1280×800 功能说明图、440×280 小宣传图、1400×560 横幅；128×128 商店图标共用。中文资料在 `zh-CN/`，英文资料在 `en/`，各自包含 `listing.md`、8 张 PNG 和 `README.md`，两套均使用对应语言的真实界面截图与说明文字。上传成品 PNG，不要上传 `assets/source/` 中的原始截图。

可直接使用 `../releases/sidebrowser-store-zh-CN-1.0.0.zip` 和 `../releases/sidebrowser-store-en-1.0.0.zip`，每个语言包内有 8 张图片、对应商店文案、尺寸／哈希清单与使用说明。`sidebrowser-store-1.0.0.zip` 仍为包含两种语言、源稿和扩展 ZIP 的完整准备包。英文使用说明见 [en/README.md](en/README.md)。

| 文件 | 用途 |
| --- | --- |
| `zh-CN/listing.md` / `en/listing.md` | 可复制的中英文商店字段与正文 |

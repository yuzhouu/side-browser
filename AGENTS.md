...
这是 Chrome Manifest V3 侧边栏浏览器扩展，当前基线版本为 1.1.0。应用源码位于 `src/`，使用 TypeScript strict 和 Vite 构建；Chrome 只加载 `dist/`。
...
- 顶部顺序：打开当前网页、竖分隔线、后退、前进、关闭当前网页、短地址栏、更多。更多内是外部新标签打开和手机／PC 切换。

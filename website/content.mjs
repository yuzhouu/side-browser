export const content = {
  zh: {
    ...
    boundaries:
      'AI 服务由所打开的网站提供；侧窗不会自动读取或发送主页面正文。网站登录、订阅与嵌入规则可能影响使用，可随时在新标签页继续。',
    source: '源代码',
    support: '反馈与支持',
    privacy: '隐私政策',
    light: '切换到浅色',
  ...
  en: {
    ...
    boundaries:
      'AI is provided by the website you open. SideBrowser does not automatically read or send main-page content. Website sign-in, subscriptions and embedding rules may affect availability; you can continue in a new tab.',
    source: 'Source code',
    support: 'Support',
